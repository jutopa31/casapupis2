...
CREATE POLICY "Lectura publica de milestones" ON historia_milestones FOR SELECT USING (true);
CREATE POLICY "Insercion publica de milestones" ON historia_milestones FOR INSERT WITH CHECK (true);
CREATE POLICY "Actualizacion publica de milestones" ON historia_milestones FOR UPDATE USING (true);
CREATE POLICY "Eliminacion publica de milestones" ON historia_milestones FOR DELETE USING (true);
...
CREATE TRIGGER historia_milestones_updated_at
  ...
  FOR EACH ROW EXECUTE FUNCTION update_historia_milestones_updated_at();
